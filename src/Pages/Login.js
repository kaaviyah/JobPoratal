...
const Login = () => {
  ...
  const isButtonDisabledLogin = Object.values(input).every(
    (value) => value !== ""
  );
  const buttonColorClassLogin = isButtonDisabledLogin
    ? "button-dark"
    : "button-light";
  ...
  return (
    <div className="register">
      <div className="row">
        <div className="login-card">
          <div className="input-box">
            ...
            <div className="form">
              ...
              <button
                className={buttonColorClassLogin}
                type="submit"
        ...
        <p className="para1">
          Already Registered?{" "}
          <button className="lbtn" onClick={handleRegClick}>
            Register
          </button>
          Here
        </p>
