...
import './MainPage.css';
import companyAImage from '../Images/Amazon.jpg'
const MainPage = () => {
  return (
    <div>
    ...
    <div className="job-form1">
      ...
      <ul>
        <li>
          <p><strong>India makes historic Moon landing</strong></p>
         </li>
         <li>
          <p><strong>Festive season fuels hiring</strong></p>
         </li>
         <li>
          <p><strong>Cafes battle rising bean prices</strong></p>
         </li>
         <li>
          <p><strong>SBI Life of hire thousands</strong></p>
         </li>
         <li>
          <p><strong>Banks records spending surge</strong></p>
         </li>
      </ul>
